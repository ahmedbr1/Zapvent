...
export class GymSessionController {
  ...
  edit = async (req: AuthRequest, res: Response) => {
    try {
      ...
      const updates = req.body as Partial<IGymSession> &
  ...
  viewScheduleByMonth = async (req: Request, res: Response) => {
    try {
...
export const gymSessionController = new GymSessionController();
export default gymSessionController;
