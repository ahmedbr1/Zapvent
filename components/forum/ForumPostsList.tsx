...
interface ForumPostsListProps {
  token: string | null;
  basePath: string; // e.g., "/user/forum", "/admin/forum", "/events-office/forum"
}

export function ForumPostsList({ token, basePath }: ForumPostsListProps) {
...
function ForumPostCard({
  ...
  const isAdminAuthor = post.authorType === "Admin";
